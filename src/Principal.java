...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cantidad Pares");
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 100, 20));

        jLabel4.setText("Cantidad Impares");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 100, 20));

        jLabel5.setText("Cantidad Primos");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 100, 20));

        txtPar.setEditable(false);
        jPanel4.add(txtPar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 60, -1));

        txtImpar.setEditable(false);
        jPanel4.add(txtImpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 60, -1));

        txtPrimos.setEditable(false);
        jPanel4.add(txtPrimos, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 140, 60, -1));
    ...
    private void cmdCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCalcularActionPerformed
        double cont = 0, conti = 0, conta = 0, ope;
        for (int i = 0; i < v.length; i++) {
            if (v[i] % 2 == 0) {
                cont++;
            } else {
        ...
        res2 = String.valueOf(conti++);
        res3 = String.valueOf(conta++);
    ...
    private void cmdMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdMostrarActionPerformed
        ...
        for (int i = 0; i < v.length; i++) {
            ...
            txtPar.setText(res);
            txtImpar.setText(res2);
            txtPrimos.setText(res3);
